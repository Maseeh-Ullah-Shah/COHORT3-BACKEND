...
//   if (req.url === "/") res.end("Dear user,app home page per ho.........");
//   else if (req.url === "/about")
//     res.end("Dear use,app about page per ho............");
//   else if (req.url === "/product")
//     res.end("Dear use app cureently product page per hooo............");
//   res.end(
//     "Currently you are not entering the correct route,please enter a correct path.......",
//   );
// });
...
const app = express()  //aisa samjo app ki andar server ban chuka hain 
